...
from cartapp.models import Cart, Cartitems, Order, Orderitem, Address, Transaction,PaymentFailure
...
class AddressSerializer(ModelSerializer):
    class Meta:
        model = Address
        fields = ['name', 'user', 'address', 'id','state' ,'pincode','mobile',"land_mark"]
...
class PaymentFailureSerializer(ModelSerializer):
    class Meta:
